...
tornado_app.controller('ApplicationController', ['$scope', '$rootScope', '$timeout', 'WebSocketService',
    function ($scope, $rootScope, $timeout, WebSocketService, uploadService) {
        ...
        $rootScope.ApplicationInit = function() {
            ...
            $scope.ApplicationStatus = WebSocketService.sendAsyncRequestWithCallback('tornado', d);
...
//        $scope.example_t1 = function () {
//            $rootScope.t1_result = WebSocketService.kick('t1', 'test.nii');
//        }
...
//        $scope.fpresult = function(e){
//            var fpfiles = e.fpfiles;
//            $.each(fpfiles, function(n, file){
//               console.log(file);
//            });
//        }
...
tornado_app.factory('WebSocketService', ['$q', '$rootScope', '$http', function ($q, $rootScope) {
    ...
    var ws = new WebSocket('ws://'+location.hostname + ':8000/ws');
...
//    Service.kick = function (command, payload) {
//
//        var request = {
//            type: command,
//            payload: payload
